   ...
   public Level3() {
    ...
    void ziel_Level3() {
    	if (squares[20][20].getBackground()==Color.red) {
    		JOptionPane.showConfirmDialog(null, "Glückwunsch du hast das Ziel erreicht, drücke auf Okay um deinen Name einzugeben.");
    		String name = JOptionPane.showInputDialog("Gebe deinen Namen ein");
    		Highscore h = new Highscore();
    		h.insertScore("Level_3", name, score);
    		System.out.println("Du hast "+score+" schritt gebraucht");
    		StartMenue.levelFrame.dispose();
    	}
    	}
}
